...
// DOWNLOAD storage = files generated by Tesseract
if (is_dir(WWW . DS . 'download')) {
    defined('DOWNLOAD') || define('DOWNLOAD', WWW . DS . 'download');
} else {
    defined('DOWNLOAD') || define('DOWNLOAD', null);
}

// UPLOAD storage = files uploaded by users
if (is_dir(WWW . DS . 'upload')) {
    defined('UPLOAD') || define('UPLOAD', WWW . DS . 'upload');
} else {
    defined('UPLOAD') || define('UPLOAD', null);
}
