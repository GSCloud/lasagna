...
quite easy to implement all types of scaling and integration.
...
now. When the user logs in, a special encrypted cookie working as a
master key is created and set via HTTPS protocol. There’s no database of
connections or users at all.
